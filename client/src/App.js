    ...
    return (
        <div className="App h-screen w-screen overflow-x-hidden flex flex-col">
            ...
            <main className="main grow flex flex-col md:flex-row justify-center items-center gap-5">
                <Canvas className={"w-full grow md:w-1/2"}/>
                <div className="w-full flex flex-col md:flex-row items-center">
                    <div className="relative w-fit mb-10">
                        <h1 className={'container_title relative text-4xl sm:text-5xl text-white bg-black lg:text-6xl border border-sm border-white' +
                    ...
                    <div className="buttons-container flex flex-col md:flex-row gap-5 items-center pb-3">
                        <button className={"predict-button text-4xl md:text-6xl text-center bg-white text-black px-12 py-2.5 w-fit rounded-xl"}>Predict</button>
                        <button className={"reset-button text-4xl md:text-6xl text-center bg-white text-black px-12 py-2.5 w-fit rounded-xl"}>Clear canvas</button>
                    </div>
                </div>
            </main>
        </div>
